...
cd "$STAGEDIR"
       ...
       cd $STAGEDIR/bin/
        ...
        wget http://artifacts.west.com/artifactory/Customer-Experience-maven-prod/notifications-walmart-skynet/master/${BuildNumber}/skynet.sh


        cd $STAGEDIR/lib/
        rm -f $STAGEDIR/lib/*.jar
        wget http://artifacts.west.com/artifactory/Customer-Experience-maven-prod/notifications-walmart-skynet/master/${BuildNumber}/skynet-${VERSION}.jar
